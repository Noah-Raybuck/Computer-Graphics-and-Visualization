...
namespace
{
    const char* const WINDOW_TITLE = "Assignment 2"; // Macro for window title
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] =
    {
        ...
        // index 2
        -0.5f, 0.0f, 0.0f,      // middle-half_left of the screen
        0.0f, 1.0f, 0.0f, 1.0f, // green
        ...
        // index 4
        -1.0f, 0.0f, 0.0f,      // middle of the screen
